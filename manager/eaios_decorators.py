...
class eaios:
    ...
    def get_plugin(cap,name):
        ...
        #     raise 
        print("lhw debug get_plugin",eaios.FUNCTION_REGISTRY)
    ...
    def scan_dir(base_package: str, base_dir: str):
        ...
        for root, dirs, files in os.walk(base_dir):
            print("lhw debug scan_dir root",root)
    ...
    def caller(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            print("lhw debug in eaios caller",getattr(skill_module, "__all__", []))
            print(skill_module.__file__)
